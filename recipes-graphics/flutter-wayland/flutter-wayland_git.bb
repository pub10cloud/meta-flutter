...
DEPENDS =+ " flutter-engine wayland virtual/egl waylandpp libxkbcommon rapidjson"

RDEPENDS_${PN} = " flutter-engine wayland virtual/egl freetype waylandpp libxkbcommon rapidjson"
