...
DEPENDS =+ " flutter-engine wayland virtual/egl waylandpp libxkbcommon rapidjson glib-2.0"

RDEPENDS_${PN} = " flutter-engine wayland virtual/egl freetype waylandpp libxkbcommon rapidjson glib-2.0"
